...
export const ScaleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M16 16.5l4-4" />
        <path d="M20 12.5v4.5h-4.5" />
        <path d="M4 12.5h4.5v-4.5" />
        <path d="M8 8.5l-4 4" />
        <path d="M12.5 20v-4.5h4.5" />
        <path d="M16.5 16l4 4" />
        <path d="M8.5 8l-4-4" />
        <path d="M12.5 4v4.5H8" />
    </svg>
);
...
export const MagnetIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15 12l-4-4" />
    <path d="m14 7 5 5" />
    <path d="M4 15v-1a4 4 0 0 1 4-4h2" />
    <path d="M8 15v-1a4 4 0 0 0-4-4H2" />
    <path d="M2 13.5V19a2 2 0 0 0 2 2h.5" />
    <path d="M20 13.5V19a2 2 0 0 1-2 2h-.5" />
  </svg>
);
