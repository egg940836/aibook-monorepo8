      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-black/30 backdrop-blur-sm border border-cyan-500/20 rounded-lg shadow-[0_0_25px_rgba(56,189,248,0.1)]">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
         ...
         <div className="text-center text-xs text-gray-500 pt-4 border-t border-gray-700/50">
            <p className="mb-1">使用者測試帳號: <span className="font-semibold text-gray-400">demo</span> / <span className="font-semibold text-gray-400">demo</span></p>
            <p>管理員測試帳號: <span className="font-semibold text-cyan-400/80">admin</span> / <span className="font-semibold text-cyan-400/80">admin</span></p>
        </div>
      </div>
    </div>
  );
