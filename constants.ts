...
export const UNIVERSAL_WEIGHTS: Record<string, number> = {
    [SUB_SCORE_KEYS.HOOK_EFFECTIVENESS]: 0.20,
    [SUB_SCORE_KEYS.RHYTHM_AND_RETENTION]: 0.20,
    [SUB_SCORE_KEYS.CTA_CLARITY]: 0.10,
    [SUB_SCORE_KEYS.READABILITY]: 0.10,
    [SUB_SCORE_KEYS.BRAND_PRESENCE]: 0.10,
    [SUB_SCORE_KEYS.PLATFORM_FIT]: 0.10,
    [SUB_SCORE_KEYS.VISUAL_QUALITY]: 0.05,
    [SUB_SCORE_KEYS.COMPOSITION]: 0.05,
    [SUB_SCORE_KEYS.AUDIO_QUALITY]: 0.05,
    [SUB_SCORE_KEYS.MESSAGE_DENSITY]: 0.05,
};
